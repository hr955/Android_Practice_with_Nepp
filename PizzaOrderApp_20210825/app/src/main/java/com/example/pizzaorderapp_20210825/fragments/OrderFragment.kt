...
class OrderFragment : Fragment() {
    ...
    private val dominoPizzaLogoUrl =
    ...
    private val mStoreList = arrayListOf<StoreData>(
        StoreData(pizzaHutLogoUrl, "피자헛", "1588-5588"),
        StoreData(papaJohnsLogoUrl, "파파존스", "1577-8080"),
        StoreData(mrPizzaLogoUrl, "미스터피자", "1577-0077"),
        StoreData(dominoPizzaLogoUrl, "도미노피자", "1577-3082")
    )
